...
const Home = () => {
  ...
  // Update real-time clock and date on component mount
  useEffect(() => {
  ...
  // Function to handle weather data fetch based on user input (এখানে বসবে)
    ...
    <div className="text-center">
      ...
      <div>
        ...
        <p className="py-4 text-md text-red-600">
          Check your weather today in My next-level
        </p>
